...
import Kpop from './client/pages/Kpop/PreKpop';
import Anime from './client/pages/Anime/PreAnime';
...
import Anime2 from './client/pages/Anime/PostAnime';
import Kpop2 from './client/pages/Kpop/PostKpop';
